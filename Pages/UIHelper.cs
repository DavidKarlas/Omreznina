...
namespace Omreznina.Client.Pages
{
    public static class UIHelper
    {
        ...
        public static string ToEuro(this double value) => $"{value:0.00}€";
        public static string ToEuro(this decimal value) => $"{value:0.00}€";
        public static string ToEuroPreferFullNumber(this double value) => value % 1 == 0 ? $"{value:0}€" : $"{value:0.00}€";
